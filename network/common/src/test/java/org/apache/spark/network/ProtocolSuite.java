...
public class ProtocolSuite {
  ...
  public void responses() {
    testServerToClient(new BlockFetchSuccess("rdd_1_2", new TestManagedBuffer(10), 0L));
    testServerToClient(new BlockFetchSuccess("rdd_1_2", new TestManagedBuffer(0), 0L));
