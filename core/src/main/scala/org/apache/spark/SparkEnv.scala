...
class SparkEnv (
  ...
  val localDagScheduler = new LocalDagScheduler(blockManager)
  blockManager.setLocalDagScheduler(localDagScheduler)
...
object SparkEnv extends Logging {
  ...
  private def create(
    ...
    val shuffleMgrName = conf.get("spark.shuffle.manager", "memory")
