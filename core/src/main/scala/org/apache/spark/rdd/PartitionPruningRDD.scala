...
import org.apache.spark.{NarrowDependency, Partition, TaskGoop}
...
class PartitionPruningRDD[T: ClassTag](
  ...
  override def compute(split: Partition, goop: TaskGoop) = firstParent[T].iterator(
    split.asInstanceOf[PartitionPruningRDDPartition].parentSplit, goop)
