...
private[spark] class NetworkRequestMonotask(
  ...
  private def updateOutstandingBytes(blockIdStr: String, callbackMethodName: String): Unit = {
  ...
  override def onSuccess(
    ...
    updateOutstandingBytes(blockId, "onSuccess")
  ...
  override def onFailure(failedBlockId: String, e: Throwable): Unit = {
    updateOutstandingBytes(failedBlockId, "onFailure")
   ...
   * of the network blocks fetched over the network.
   */
